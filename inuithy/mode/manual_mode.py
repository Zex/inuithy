...
from inuithy.common.predef import T_CTRLCMD, CtrlCmd, T_CLIENTID, T_NODE,\
T_HOST, T_NODES, TRAFFIC_CONFIG_PATH, INUITHY_TOPIC_HEARTBEAT, INUITHY_TOPIC_STATUS,\
INUITHY_TOPIC_REPORTWRITE, INUITHY_TOPIC_NOTIFICATION, T_TID, T_TRAFFIC_STATUS,\
TrafficStatus, AgentStatus, TRAFFIC_CONFIG_PATH, string_write, INUITHYCONTROLLER_CLIENT_ID,\
INUITHY_TOPIC_UNREGISTER, T_TRAFFIC_TYPE, T_PANID, TrafficType, INUITHY_CONFIG_PATH,\
...
class ManualController(object):
    ...
    @property
    def initialized():
        return ManualController.__initialized
    @initialized.setter
    def initialized(val):
...
#            message.topic))
    ...
    def __init__(self, inuithy_cfgpath='config/inuithy.conf',\
        ...
        if self.load_configs(inuithy_cfgpath, traffic_cfgpath):
            ...
            self.__traffic_timer = None
            #thrd.Timer(delay, self.__traffic_state.start)
